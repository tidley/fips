...
impl SessionEntry {
    ...
    ///
    /// For initiators, this is the SessionSetup payload bytes while
    /// initiating, then the final SessionMsg3 payload briefly after
    /// establishment so duplicate SessionAck packets can repair a lost msg3.
