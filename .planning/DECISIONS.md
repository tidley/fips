...
## 2026-05-04 - Android FIPS Dropbox PoC direction

The Android Dropbox proof of concept should use embedded, app-owned FIPS communication rather than a separate Android FIPS/VPN app or system-wide gateway.
...
- Dropbox app payloads should ride a FIPS service-port channel after the FIPS session is ready.
- Blossom/file metadata comes after direct FIPS payload transfer works.

## 2026-05-04 - Product PoC sequence

For Pushstr/FIPS Dropbox, prove the direct app path first:
